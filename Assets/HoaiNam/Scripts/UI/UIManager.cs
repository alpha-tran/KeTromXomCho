    ...
    public class UIManager : Singleton<UIManager>
{
    ...
    private BaseNotify GetNewNotify<T>() where T : BaseNotify
    {
        ...
        GameObject pfNotify = GetUIPrefab(Enums.UIType.Notify, nameNotify);
    ...
    private BaseOverlap GetNewOverLap<T>() where T : BaseOverlap
    {
        ...
        GameObject pfOverlap = GetUIPrefab(Enums.UIType.Overlap, nameOverlap);
    ...
    private GameObject GetUIPrefab(Enums.UIType t, string uiName)
    {
